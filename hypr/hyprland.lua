-- Catppuccin Macchiato - Hyprland Lua Config
-- Converted from hyprland.conf for Hyprland 0.56+
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("dconf write /org/gnome/desktop/interface/cursor-theme \"'catppuccin-macchiato-lavender-cursors'\"")
...
hl.config({
    general = {
        ...
        border_size       = 2,
        col = {
            active_border   = { colors = {"rgba(91d7e3ee)", "rgba(f5bde6ee)"}, angle = 90 },
            inactive_border = "rgba(6e738daa)",
        },
...
-- Gestures (separate from config in Lua)
hl.gesture({
    fingers   = 3,
